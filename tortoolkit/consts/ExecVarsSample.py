try:
    ...
    class ExecVars:
        ...
        API_HASH = "8265fba1f5c16951c59b3404d598049c"
        API_ID = 10261766
        BOT_TOKEN = "5595596125:AAGpVo5MoN3zUFgd0gJOdRu9lryHqh5bvog"
        BASE_URL_OF_BOT = "http://54.177.9.157"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [-1001221415234]
        OWNER_ID = 5200751866
